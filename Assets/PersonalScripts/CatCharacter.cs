...
public class CatCharacter : MonoBehaviour, IAnimalCharacter
{
    ...
    public void FeedAnimal(IFood food)
    {
        ...
        pleasureAmnt += food.fishey - _catPrefs.fishPref;
        pleasureAmnt += food.meaty - _catPrefs.meatPref;
        pleasureAmnt += food.watery - _catPrefs.wateryPref;
        pleasureAmnt += food.sweet - _catPrefs.sweetPref;
    ...
    public void PlayWithAnimal(IToy toy)
    {
        ...
        int pleasureAmnt = 0;
        // what the pet wants - what they get = pleasure level
        pleasureAmnt += toy.bouncy - _catPrefs.bouncePref;
        pleasureAmnt += toy.smooth - _catPrefs.smoothPref;
        pleasureAmnt += toy.squishey - _catPrefs.squishPref;
        // adds to pets happiness
        happiness += pleasureAmnt;
        // fatigue effects
