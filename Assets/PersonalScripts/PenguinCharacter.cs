...
public class PenguinCharacter : MonoBehaviour, IAnimalCharacter
{
    private const int FULL = 100;
    private const int EMPTY = 0;
    string _nickName = "Mr.Penguin";

    // animal status traits and depletion rates
    public AnimalPreferences _penguinPrefs;
    int _hunger, _hungerDepletionRate = 5;
    int _thirst, _thirstDepletionRate = 5;
    int _happiness, _happinessDepletionRate = 8;
    int _fatigue, _fatigueDepeletionRate = 1;
    int _bladderCapacity, _bladderCapacityDepletionRate = 2;
    int _boredom, _boredomDepletionRate = 8;
    ...
    public void Start()
    {
        ...
        _penguinPrefs = new AnimalPreferences(70, 10, 50, 75, 40, 15, 3);
    ...
    public void FeedAnimal(IFood food)
    {
        ...
        pleasureAmnt += food.fishey - _penguinPrefs.fishPref;
        pleasureAmnt += food.meaty - _penguinPrefs.meatPref;
        pleasureAmnt += food.watery - _penguinPrefs.wateryPref;
        pleasureAmnt += food.sweet - _penguinPrefs.sweetPref;
    ...
    public void PlayWithAnimal(IToy toy)
    {
        ...
        int pleasureAmnt = 0;
        // what the pet wants - what they get = pleasure level
        pleasureAmnt += toy.bouncy - _penguinPrefs.bouncePref;
        pleasureAmnt += toy.smooth - _penguinPrefs.smoothPref;
        pleasureAmnt += toy.squishey - _penguinPrefs.squishPref;
        // adds to pets happiness
        happiness += pleasureAmnt;
        // fatigue effects
