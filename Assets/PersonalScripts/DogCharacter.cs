...
public class DogCharacter : MonoBehaviour, IAnimalCharacter
{
    private const int FULL = 100;
    private const int EMPTY = 0;
    string _nickName = "Mr.Doggy";

    // animal status traits and depletion rates
    public AnimalPreferences _dogPrefs;
    int _hunger, _hungerDepletionRate = 10;
    ...
    public void Start()
    {
        ...
        _dogPrefs = new AnimalPreferences(70, 10, 50, 75, 40, 15, 3);
    ...
    public void FeedAnimal(IFood food)
    {
        ...
        pleasureAmnt += food.fishey - _dogPrefs.fishPref;
        pleasureAmnt += food.meaty - _dogPrefs.meatPref;
        pleasureAmnt += food.watery - _dogPrefs.wateryPref;
        pleasureAmnt += food.sweet - _dogPrefs.sweetPref;
    ...
    public void PlayWithAnimal(IToy toy)
    {
        ...
        int pleasureAmnt = 0;
        // what the pet wants - what they get = pleasure level
        pleasureAmnt += toy.bouncy - _dogPrefs.bouncePref;
        pleasureAmnt += toy.smooth - _dogPrefs.smoothPref;
        pleasureAmnt += toy.squishey - _dogPrefs.squishPref;
        // adds to pets happiness
        happiness += pleasureAmnt;
        // fatigue effects
