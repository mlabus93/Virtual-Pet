...
public class RabbitCharacter : MonoBehaviour, IAnimalCharacter
{
    ...
    string _nickName = "Mr.Rabbit";

    // animal status traits and depletion rates
    public AnimalPreferences _rabbitPrefs;
    int _hunger, _hungerDepletionRate = 4;
    int _thirst, _thirstDepletionRate = 10;
    int _happiness, _happinessDepletionRate = 1;
    int _fatigue, _fatigueDepeletionRate = 1;
    int _bladderCapacity, _bladderCapacityDepletionRate = 1;
    int _boredom, _boredomDepletionRate = 3;
    ...
    public void Start()
    {
        ...
        _rabbitPrefs = new AnimalPreferences(70, 10, 50, 75, 40, 15, 3);
    ...
    public void FeedAnimal(IFood food)
    {
        ...
        pleasureAmnt += food.fishey - _rabbitPrefs.fishPref;
        pleasureAmnt += food.meaty - _rabbitPrefs.meatPref;
        pleasureAmnt += food.watery - _rabbitPrefs.wateryPref;
        pleasureAmnt += food.sweet - _rabbitPrefs.sweetPref;
    ...
    public void PlayWithAnimal(IToy toy)
    {
        ...
        int pleasureAmnt = 0;
        // what the pet wants - what they get = pleasure level
        pleasureAmnt += toy.bouncy - _rabbitPrefs.bouncePref;
        pleasureAmnt += toy.smooth - _rabbitPrefs.smoothPref;
        pleasureAmnt += toy.squishey - _rabbitPrefs.squishPref;
        // adds to pets happiness
        happiness += pleasureAmnt;
        // fatigue effects
