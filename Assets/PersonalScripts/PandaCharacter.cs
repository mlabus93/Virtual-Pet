...
public class PandaCharacterCharacter : MonoBehaviour, IAnimalCharacter
{
    ...
    string _nickName = "Mr.Panda";

    // animal status traits and depletion rates
    public AnimalPreferences _pandaPrefs;
    int _hunger, _hungerDepletionRate = 4;
    int _thirst, _thirstDepletionRate = 2;
    ...
    public void Start()
    {
        ...
        _pandaPrefs = new AnimalPreferences(70, 10, 50, 75, 40, 15, 3);
    ...
    public void FeedAnimal(IFood food)
    {
        ...
        pleasureAmnt += food.fishey - _pandaPrefs.fishPref;
        pleasureAmnt += food.meaty - _pandaPrefs.meatPref;
        pleasureAmnt += food.watery - _pandaPrefs.wateryPref;
        pleasureAmnt += food.sweet - _pandaPrefs.sweetPref;
    ...
    public void PlayWithAnimal(IToy toy)
    {
        ...
        int pleasureAmnt = 0;
        // what the pet wants - what they get = pleasure level
        pleasureAmnt += toy.bouncy - _pandaPrefs.bouncePref;
        pleasureAmnt += toy.smooth - _pandaPrefs.smoothPref;
        pleasureAmnt += toy.squishey - _pandaPrefs.squishPref;
        // adds to pets happiness
        happiness += pleasureAmnt;
        // fatigue effects
